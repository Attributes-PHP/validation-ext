...
static zend_string* zend_string_init(const char *str, size_t len) {
    ...
    memcpy(zs->val, str, len);
    zs->val[len] = '\0';
    zs->len = len;
    zs->h = 0;
    zs->gc.refcount = 1;
    zs->gc.u.type_info = IS_STRING;
    return zs;
}

static zend_string* zend_string_release(zend_string *string) {
    if (string != NULL) {
        free(string);
    }
}
...
void test_to_pascal_case_snake_case(void) {
    zend_string* input = zend_string_init("first_name", sizeof("first_name") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
...
void test_to_pascal_case_kebab_case(void) {
    zend_string* input = zend_string_init("first-name", sizeof("first-name") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
    TEST_ASSERT_EQUAL_STRING("FirstName", result->val);
    zend_string_release(input);
    zend_string_release(result);
...
void test_to_pascal_case_camel_case(void) {
    zend_string* input = zend_string_init("firstName", sizeof("firstName") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
    TEST_ASSERT_EQUAL_STRING("FirstName", result->val);
    zend_string_release(input);
    zend_string_release(result);
...
void test_to_pascal_case_multiple_separators(void) {
    zend_string* input = zend_string_init("first_name_last-name", sizeof("first_name_last-name") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
...
void test_to_pascal_case_single_word(void) {
    zend_string* input = zend_string_init("name", sizeof("name") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
...
void test_to_pascal_case_empty(void) {
    zend_string* input = zend_string_init("", sizeof("") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
...
void test_to_pascal_case_numbers(void) {
    zend_string* input = zend_string_init("user2_name", sizeof("user2_name") - 1);
    zend_string* result = attributes_validation_to_pascal_case(input);
...
void test_to_camel_case_snake_case(void) {
    zend_string* input = zend_string_init("first_name", sizeof("first_name") - 1);
    zend_string* result = attributes_validation_to_camel_case(input);
    TEST_ASSERT_EQUAL_STRING("firstName", result->val);
    zend_string_release(input);
    zend_string_release(result);
}
...
void test_to_snake_case_pascal_case(void) {
    zend_string* input = zend_string_init("FirstName", sizeof("FirstName") - 1);
    zend_string* result = attributes_validation_to_snake_case(input);
...
void test_to_snake_case_consecutive_uppercase(void) {
    zend_string* input = zend_string_init("HTTPResponse", sizeof("HTTPResponse") - 1);
    zend_string* result = attributes_validation_to_snake_case(input);
...
void test_to_snake_case_numbers(void) {
    zend_string* input = zend_string_init("user2Name", sizeof("user2Name") - 1);
    zend_string* result = attributes_validation_to_snake_case(input);
...
void test_to_kebab_case_pascal_case(void) {
    zend_string* input = zend_string_init("FirstName", sizeof("FirstName") - 1);
    zend_string* result = attributes_validation_to_kebab_case(input);
...
void test_no_input_modification(void) {
    ...
    attributes_validation_to_pascal_case(input);
    TEST_ASSERT_EQUAL_STRING(original_val, input->val);
    TEST_ASSERT_EQUAL(original_len, input->len);
    
    attributes_validation_to_camel_case(input);
    TEST_ASSERT_EQUAL_STRING(original_val, input->val);
    TEST_ASSERT_EQUAL(original_len, input->len);
    
    attributes_validation_to_snake_case(input);
    TEST_ASSERT_EQUAL_STRING(original_val, input->val);
    TEST_ASSERT_EQUAL(original_len, input->len);
    
    attributes_validation_to_kebab_case(input);
    TEST_ASSERT_EQUAL_STRING(original_val, input->val);
    TEST_ASSERT_EQUAL(original_len, input->len);
