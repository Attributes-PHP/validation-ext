...
static const zend_function_entry class_AV_BaseModel_methods[] = {ZEND_ME(AV_BaseModel, beforeValidation, arginfo_class_AV_BaseModel_beforeValidation, ZEND_ACC_PROTECTED)
                                                                     ZEND_ME(AV_BaseModel, afterValidation, arginfo_class_AV_BaseModel_afterValidation, ZEND_ACC_PROTECTED) ZEND_FE_END};
