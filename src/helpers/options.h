...
static inline void throw_invalid_parameter_exception(char *value, char **all_options, size_t length, attributes_validation_invalid_method_parameter *invalid_parameter_error);
