...
#define AV_ZVAL_DTOR_RETURN_THROWS(...) AV_ZVAL_DTOR_RETURN_THROWS_N(__VA_ARGS__, 2, 1)(__VA_ARGS__)

#define AV_ZVAL_DTOR_RETURN_THROWS_N(_1, _2, N, ...) AV_ZVAL_DTOR_RETURN_THROWS_##N
