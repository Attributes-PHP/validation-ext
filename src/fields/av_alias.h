...
static const zend_function_entry class_AV_Fields_Alias_methods[] = {ZEND_ME(AV_Fields_Alias, __construct, arginfo_class_AV_Fields_Alias___construct, ZEND_ACC_PUBLIC) ZEND_FE_END};
