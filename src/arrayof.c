...
zend_class_entry *Attributes_Validation_Types_ArrayOf_ce;
...
ZEND_METHOD(Attributes_Validation_Types_ArrayOf, __construct)
{
    ...
    zend_update_property(Attributes_Validation_Types_ArrayOf_ce, Z_OBJ_P(getThis()), "type", sizeof("type") - 1, &type_array);
...
{
    zend_class_entry ce;
    INIT_NS_CLASS_ENTRY(ce, "Attributes\\Validation\\Types", "ArrayOf", class_Attributes_Validation_Types_ArrayOf_methods);
    Attributes_Validation_Types_ArrayOf_ce = zend_register_internal_class_ex(&ce, NULL);
    
    /* Register $type property */
    zend_declare_property_null(Attributes_Validation_Types_ArrayOf_ce, "type", sizeof("type") - 1, ZEND_ACC_PUBLIC);
    
    /* Register as an internal attribute that can be used on properties and parameters */
    zend_internal_attribute_register(
        Attributes_Validation_Types_ArrayOf_ce,
